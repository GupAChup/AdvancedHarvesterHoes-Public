package io.github.advancedfarms.gui;
...
public class UpgradeGUI {
    ...
    public UpgradeGUI(AdvancedFarms plugin) {
        this.plugin = plugin;
    }
    ...
    public Inventory openInventory(Player player, ItemStack item) {
        ...
        ItemStack autoSell = Extras.getCustomSkull(player);
        ...
        ItemStack radius = Extras.getCustomSkull(player);
        ...
        ItemStack fragment = Extras.getCustomSkull(player);
        ...
        ItemStack custom = Extras.getCustomSkull(player);
